...
public class HaiCellUnitTest {
  ...
  public void test() throws Exception {
    ...
    Assert.assertEquals(cell.getFieldAsDouble("double"), _double) ;
    Assert.assertEquals(cell.getFieldAsFloat("float"), _float) ;
    ...
    Assert.assertEquals(sel.getFieldAsDouble("double"), _double) ;
    Assert.assertEquals(sel.getFieldAsFloat("float"), _float) ;
